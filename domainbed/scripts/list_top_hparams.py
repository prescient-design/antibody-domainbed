        ...
        for group in records:
            ...
            for run_acc, hparam_records in best_hparams:
                ...
                for output_dir in output_dirs:
                    print(f"\t\t\t{output_dir}")
                    dir_names.append(output_dir)
                out_dict[
                        selection_method.name][
                            group['trial_seed']]['dir_name'] = dir_names
    np.save(
        f'list_top_hparams_out_alg_{args.algorithm}_env_{args.test_env}.npy',
        out_dict.to_dict(), allow_pickle=True)
